...
with st.sidebar:
    ...
    st.markdown("""
    <div style='font-size:11px; color:#556644; line-height:1.6;'>
    <b style='color:#8aaa70;'>IF4061 Visualisasi Data</b><br>
...
with card1:
    ...
    <div style='
        background: #1c3319;
        border: 1px solid #2d5a2d;
        border-top: 3px solid #7ab528;
        border-radius: 8px;
        padding: 20px;
        height: 170px;
    '>
      <div style='color:#7ab528; font-weight:700; font-size:0.9rem; margin-bottom:8px;'>
        PRODUKSI BERAS NASIONAL
      </div>
      <div style='color:#e8f0e0; font-size:0.9rem; line-height:1.6;'>
        Total produksi padi nasional mencapai
        <span style='color:#d4a520; font-weight:700; font-size:1.1rem;'>
...
with card2:
    ...
    <div style='
        ...
        height: 170px;
    '>
      <div style='color:#c53030; font-weight:700; font-size:0.9rem; margin-bottom:8px;'>
        ZONA KRITIS PANGAN
      </div>
      <div style='color:#e8f0e0; font-size:0.9rem; line-height:1.6;'>
        <span style='color:#c53030; font-weight:700;'>{stats['worst_province']}</span>
        memiliki IKP terendah
        <span style='color:#c53030; font-weight:700;'>{stats['worst_ikp']}</span>
...
with card3:
    ...
    <div style='
        ...
        height: 170px;
    '>
      <div style='color:#d4a520; font-weight:700; font-size:0.9rem; margin-bottom:8px;'>
        GAP HARGA BARAT–TIMUR
      </div>
      <div style='color:#e8f0e0; font-size:0.9rem; line-height:1.6;'>
        Harga beras di Papua &amp; Maluku rata-rata
        <span style='color:#d4a520; font-weight:700;'>Rp {stats['east_avg']}rb/kg</span>
        vs Jawa
        <span style='color:#7ab528; font-weight:700;'>Rp {stats['west_avg']}rb/kg</span>
        — selisih
        <span style='color:#d4a520; font-weight:700;'>{stats['price_gap_pct']}%</span>.
      </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col:
        ...
        <a href="{page['href']}" target="_self" style="text-decoration:none;">
          ...
          '>
            ...
            <div style='color:#a8c878; font-size:0.68rem; line-height:1.4;'>
              {page['desc']}
            </div>
          </div>
        </a>
